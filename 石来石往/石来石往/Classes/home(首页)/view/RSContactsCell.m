...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        touImageView.image = [UIImage imageNamed:@"联系人管理"];
        ...
        //联系人电话号码
        UILabel * contactNameNumberLabel = [[UILabel alloc]init];
        contactNameNumberLabel.textAlignment = NSTextAlignmentLeft;
        contactNameNumberLabel.text = @"123456788";
        contactNameNumberLabel.textColor = [UIColor colorWithHexColorStr:@"#999999"];
        contactNameNumberLabel.font = [UIFont systemFontOfSize:14];
        [self.contentView addSubview:contactNameNumberLabel];
        _contactNameNumberLabel = contactNameNumberLabel;
        ...
        contactNameNumberLabel.sd_layout
        .leftSpaceToView(touImageView, 9)
        .topSpaceToView(contactsNameLabel, 0)
        .heightIs(touImageView.yj_height/2)
        .widthRatioToView(self.contentView, 0.5);
