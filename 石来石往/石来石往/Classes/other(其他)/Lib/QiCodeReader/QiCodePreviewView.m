...
- (instancetype)initWithFrame:(CGRect)frame rectFrame:(CGRect)rectFrame rectColor:(UIColor *)rectColor {
    ...
    if (self) {
        ...
        _torchSwithButton.imageEdgeInsets = UIEdgeInsetsMake(.0, 15, _torchSwithButton.titleLabel.frame.size.height + 5.0, - _torchSwithButton.titleLabel.bounds.size.width / 4);
