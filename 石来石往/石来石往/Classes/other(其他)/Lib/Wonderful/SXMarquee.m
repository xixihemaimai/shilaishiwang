...
- (void)addLeftAndRightGradient{
    ...
    SXColorGradientView *rightFade = [SXColorGradientView createWithColor:self.bgColor frame:CGRectMake(w, 0, h, h) direction:SXGradientToLeft];
