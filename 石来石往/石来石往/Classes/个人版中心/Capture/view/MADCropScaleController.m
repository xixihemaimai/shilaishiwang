...
//        ZZImageEditTool *tool = [ZZImageEditTool showViewWithImg:_cropImage andSelectClipRatio:0];
////        tool.cancelBlock = ^{
//            // 重拍
//            //[weakSelf onRetake];
////        };
...
//
//            _cropImage = image;
//            weakself.view.layer.contents = (__bridge id _Nullable)(_cropImage.CGImage);
//
//        };
