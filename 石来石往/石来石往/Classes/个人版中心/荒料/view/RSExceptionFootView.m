...
@implementation RSExceptionFootView

- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
    
        self.backgroundColor = [UIColor colorWithHexColorStr:@"#f5f5f5"];
        
        UIView * exceptionView =[[UIView alloc]initWithFrame:CGRectMake(12, 5, SCW - 24, 184)];
       ...
       // exceptionView.layer.masksToBounds = YES;
...
- (void)setStoragemanagementmodel:(RSStoragemanagementModel *)storagemanagementmodel{
    ...
    _productNameLabel.text = storagemanagementmodel.blockInNo;
