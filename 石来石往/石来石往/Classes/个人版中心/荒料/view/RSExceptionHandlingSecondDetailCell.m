//
//  RSExceptionHandlingSecondDetailCell.m
//  石来石往
//
...
@interface RSExceptionHandlingSecondDetailCell()
...
@implementation RSExceptionHandlingSecondDetailCell
...
//- (void)setOcrblockdetailmodel:(RSOcrBlockDetailModel *)ocrblockdetailmodel{
//    _ocrblockdetailmodel = ocrblockdetailmodel;
//    
//    _productNameLabel.text = ocrblockdetailmodel.stoneNo;
//    
//    _productDetailLabel.text = ocrblockdetailmodel.stoneName;
//    
//    _productTypeDetailLabel.text = ocrblockdetailmodel.stoneType;
//    _productShapeDetailLabel.text = [NSString stringWithFormat:@"%0.1lf/%0.1lf/%0.1lf",ocrblockdetailmodel.length,ocrblockdetailmodel.width,ocrblockdetailmodel.height];
//    _productAreaDetailLabel.text = [NSString stringWithFormat:@"%0.3lf",ocrblockdetailmodel.vaqty];
//    
//    _productWightDetailLabel.text = [NSString stringWithFormat:@"%0.3lf",ocrblockdetailmodel.weight];
//    
//}



- (void)setStoragemaanagementmodel:(RSStoragemanagementModel *)storagemaanagementmodel{
    _storagemaanagementmodel = storagemaanagementmodel;
    if ([_storagemaanagementmodel.blockNo isEqualToString:@""] || _productNameLabel.text == NULL) {
        _productNameLabel.textColor = [UIColor redColor];
    }else{
        _productNameLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
    }
    
    if ([_storagemaanagementmodel.mtlName isEqualToString:@""] || _productNameLabel.text == NULL) {
        _productDetailLabel.textColor = [UIColor redColor];
    }else{
        _productDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
    }
    
    
    if ([_storagemaanagementmodel.mtltypeName isEqualToString:@""] || _productNameLabel.text == NULL) {
        
        _productTypeDetailLabel.textColor = [UIColor redColor];
    
    }else{
        
        _productTypeDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
    }
    
    if ([_storagemaanagementmodel.volume doubleValue] <= 0.000) {
        
         _productAreaDetailLabel.textColor = [UIColor redColor];
        
    }else{
        _productAreaDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
    }
    
    if ([_storagemaanagementmodel.length doubleValue] <= 0.000 || [_storagemaanagementmodel.width doubleValue] <= 0.000 || [_storagemaanagementmodel.height doubleValue] <= 0.000 ) {
        _productShapeDetailLabel.textColor = [UIColor redColor];
        
    }else{
        _productShapeDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
    }
    
//    if ([_storagemaanagementmodel.weight doubleValue] <= 0.000) {
//        _productWightDetailLabel.textColor = [UIColor redColor];
//    }else{
        _productWightDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
//    }
    
    
    _productNameLabel.text = _storagemaanagementmodel.blockNo;
    _productDetailLabel.text = _storagemaanagementmodel.mtlName;
    
    _productTypeDetailLabel.text = _storagemaanagementmodel.mtltypeName;
    _productShapeDetailLabel.text = [NSString stringWithFormat:@"%0.1lf/%0.1lf/%0.2lf",[_storagemaanagementmodel.length doubleValue],[_storagemaanagementmodel.width doubleValue],[_storagemaanagementmodel.height doubleValue]];
    
    _productAreaDetailLabel.text = [NSString stringWithFormat:@"%0.3lf",[_storagemaanagementmodel.volume doubleValue]];
    _productWightDetailLabel.text = [NSString stringWithFormat:@"%0.3lf",[_storagemaanagementmodel.weight doubleValue]];
}



//- (void)setSelectiveInventorymodel:(RSSelectiveInventoryModel *)selectiveInventorymodel{
//    _selectiveInventorymodel = selectiveInventorymodel;
//
//    if ([_selectiveInventorymodel.blockNo isEqualToString:@""] || _productNameLabel.text == NULL) {
//        _productNameLabel.textColor = [UIColor redColor];
//
//    }else{
//
...
//
//
//    if ([_selectiveInventorymodel.mtlName isEqualToString:@""] || _productNameLabel.text == NULL) {
//        _productDetailLabel.textColor = [UIColor redColor];
//    }else{
//        _productDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
//    }
//
//
//    if ([_selectiveInventorymodel.mtltypeName isEqualToString:@""] || _productNameLabel.text == NULL) {
//
//        _productTypeDetailLabel.textColor = [UIColor redColor];
//    }else{
//        _productTypeDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
...
//    }
//
//    if ([_selectiveInventorymodel.volume doubleValue] <= 0.000) {
//        _productAreaDetailLabel.textColor = [UIColor redColor];
//    }else{
//        _productAreaDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
//    }
//
//    if ([_selectiveInventorymodel.length doubleValue] <= 0.000 || [_selectiveInventorymodel.width doubleValue] <= 0.000 || [_selectiveInventorymodel.height doubleValue] <= 0.000 ) {
//        _productShapeDetailLabel.textColor = [UIColor redColor];
//    }else{
//        _productWightDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
//    }
//
//    if ([_selectiveInventorymodel.weight doubleValue] <= 0.000) {
//        _productWightDetailLabel.textColor = [UIColor redColor];
//    }else{
//
//        _productWightDetailLabel.textColor = [UIColor colorWithHexColorStr:@"#333333"];
...
//
//
//    _productNameLabel.text = _selectiveInventorymodel.blockNo;
//    _productDetailLabel.text = _selectiveInventorymodel.mtlName;
//
//    _productTypeDetailLabel.text = _selectiveInventorymodel.mtltypeName;
//    _productShapeDetailLabel.text = [NSString stringWithFormat:@"%0.1lf/%0.1lf/%0.2lf",[_selectiveInventorymodel.length doubleValue],[_selectiveInventorymodel.width doubleValue],[_selectiveInventorymodel.height doubleValue]];
//
//    _productAreaDetailLabel.text = [NSString stringWithFormat:@"%0.3lf",[_selectiveInventorymodel.volume doubleValue]];
//    _productWightDetailLabel.text = [NSString stringWithFormat:@"%0.3lf",[_selectiveInventorymodel.weight doubleValue]];
//
//}
