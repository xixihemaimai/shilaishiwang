//
//  RSExceptionHandlingThirdCell.m
//  石来石往
//
...
@interface RSExceptionHandlingThirdCell()

{
    ...
    UILabel * _productTypeModifyLabel;
}


@end

@implementation RSExceptionHandlingThirdCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UILabel * productTypeModifyLabel = [[UILabel alloc]init];
        //[newPrice addAttribute:NSStrikethroughStyleAttributeName value:@(NSUnderlinePatternSolid | NSUnderlineStyleSingle) range:NSMakeRange(0, newPrice.length)];
        NSDictionary *attribtDic3 = @{NSStrikethroughStyleAttributeName: [NSNumber numberWithInteger:NSUnderlineStyleSingle]};
        
        NSMutableAttributedString * attribtStr3 = [[NSMutableAttributedString alloc]initWithString:@"白玉蓝" attributes:attribtDic3];
        //[[NSMutableAttributedString alloc]initWithString:oldStrattributes:attribtDic];
        productTypeModifyLabel.attributedText= attribtStr3;
        
        productTypeModifyLabel.font = [UIFont systemFontOfSize:10];
        productTypeModifyLabel.textColor = [UIColor colorWithHexColorStr:@"#D0021B"];
        productTypeModifyLabel.textAlignment = NSTextAlignmentRight;
        [exceptionView addSubview:productTypeModifyLabel];
        _productTypeModifyLabel = productTypeModifyLabel;
        ...
        .topSpaceToView(productTypeLabel, 10)
        .widthIs(85)
        .heightIs(21);
...
- (void)setStoragemanagementmodel:(RSStoragemanagementModel *)storagemanagementmodel{
    ...
    _productDetailLabel.text = storagemanagementmodel.mtlInName;
    _productTypeDetailLabel.text = storagemanagementmodel.mtltypeInName;
    ...
    if ([storagemanagementmodel.mtlName isEqualToString:storagemanagementmodel.mtlInName]) {
        ...
        NSMutableAttributedString *newPrice = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@",[NSString stringWithFormat:@"%@",storagemanagementmodel.mtlName]]];
        [newPrice addAttribute:NSStrikethroughStyleAttributeName value:@(NSUnderlinePatternSolid | NSUnderlineStyleSingle) range:NSMakeRange(0, newPrice.length)];
         _productModifyLabel.attributedText = newPrice;
    }
    
    if ([storagemanagementmodel.mtltypeName isEqualToString:storagemanagementmodel.mtltypeInName]) {
        _productTypeModifyLabel.hidden = YES;
    }else{
        _productTypeModifyLabel.hidden = NO;
        NSMutableAttributedString * newPrice1 = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@",[NSString stringWithFormat:@"%@",storagemanagementmodel.mtltypeName]]];
        ...
        _productTypeModifyLabel.attributedText = newPrice1;
    }
