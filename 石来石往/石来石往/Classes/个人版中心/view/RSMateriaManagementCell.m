...
@implementation RSMateriaManagementCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        materiaManagementImageView.image = [UIImage imageNamed:@"Oval 10"];
        materiaManagementImageView.clipsToBounds = YES;
        materiaManagementImageView.contentMode = UIViewContentModeScaleAspectFill;
        ...
        _materiaManagemnetNameLabel = materiaManagemnetNameLabel;
        
        //物料名称内容
        UILabel * nameDetialLabel  = [[UILabel alloc]init];
        nameDetialLabel.text = @"白玉兰";
