...
@interface RSRunningAccountCloseCell()
...
@implementation RSRunningAccountCloseCell
...
//    {
//        [self.delegate baseCell:self btnType:OPEN WithIndex:self.index withArr:self.indexArr withOpenArr:self.openArr];
//    }
//}
