...
@interface RSDabanAbnormalThirdCell()
...
@implementation RSDabanAbnormalThirdCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        self.contentView.backgroundColor = [UIColor colorWithHexColorStr:@"#F3F3F3"];
        ...
        UILabel * productNameMidifyLabel = [[UILabel alloc]init];
        productNameMidifyLabel.font = [UIFont systemFontOfSize:10];
        NSDictionary *attribtDic1 = @{NSStrikethroughStyleAttributeName: [NSNumber numberWithInteger:NSUnderlineStyleSingle]};
        
        NSMutableAttributedString * attribtStr1 = [[NSMutableAttributedString alloc]initWithString:@"白玉蓝" attributes:attribtDic1];
        //[[NSMutableAttributedString alloc]initWithString:oldStrattributes:attribtDic];
        productNameMidifyLabel.attributedText= attribtStr1;
        
        productNameMidifyLabel.textColor = [UIColor colorWithHexColorStr:@"#D0021B"];
        productNameMidifyLabel.textAlignment = NSTextAlignmentLeft;
        [exceptionView addSubview:productNameMidifyLabel];
        
        productNameMidifyLabel.sd_layout
        ...
        .leftEqualToView(productNameLabel)
        .topSpaceToView(productNameMidifyLabel, 0)
        .rightEqualToView(productNameLabel)
        .heightIs(17);
...
- (void)setChoosingInventorymodel:(RSChoosingInventoryModel *)choosingInventorymodel{
   ...
   // NSMutableArray * selectArray = [dict objectForKey:@"selectArray"];
    ...
    if (choosingInventorymodel.isBool) {
        ...
        CGRect rect = CGRectMake(0, 0, SCW - 24, 106);
        CGRect oldRect = rect;
