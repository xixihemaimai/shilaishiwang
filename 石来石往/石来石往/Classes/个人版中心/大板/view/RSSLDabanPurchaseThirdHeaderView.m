//
//  RSSLDabanPurchaseThirdHeaderView.m
//  石来石往
//
...
@interface RSSLDabanPurchaseThirdHeaderView()
{
...
@implementation RSSLDabanPurchaseThirdHeaderView
...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithReuseIdentifier:reuseIdentifier]) {
        ...
        UILabel * productModiftyLabel = [[UILabel alloc]init];
        productModiftyLabel.font = [UIFont systemFontOfSize:14];
        productModiftyLabel.textColor = [UIColor colorWithHexColorStr:@"#D0021B"];
        productModiftyLabel.textAlignment = NSTextAlignmentLeft;
        [exceptionView addSubview:productModiftyLabel];
        
        
//        CGSize size6 = [self obtainLabelTextSize:@"2.3" andFont:productModiftyLabel.font];
//        productModiftyLabel.text = @"0.1";
...
//        productModiftyLabel.attributedText= attribtStr1;
        _productModiftyLabel = productModiftyLabel;
        productModiftyLabel.sd_layout
        ...
        .leftEqualToView(productNameLabel)
        .topSpaceToView(productModiftyLabel, 0)
        .rightEqualToView(productNameLabel)
        .heightIs(17);
