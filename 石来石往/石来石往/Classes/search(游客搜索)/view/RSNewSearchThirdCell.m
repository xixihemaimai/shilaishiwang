...
@interface RSNewSearchThirdCell()
...
@implementation RSNewSearchThirdCell
...
-(void)setCompanyAndStonemodel:(RSCompanyAndStoneModel *)companyAndStonemodel{
    ...
    if ([_companyAndStonemodel.stockType isEqualToString:@"daban"]) {
        ...
        _fristMingLabel.text = [NSString stringWithFormat:@"%@",_companyAndStonemodel.turnsQty];
