...
@interface RSShipmentViewController ()


@end

@implementation RSShipmentViewController


- (YJTopicType)type
{
    // 返回待发货数据
    return YJTopicTypeshipment;
}
...
//        cell.detailStatusLabel.textColor = [UIColor blueColor];
//        
//        
//    }
